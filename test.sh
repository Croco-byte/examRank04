...
./microshell /bin/ls "|" /bin/grep microshell "|" /bin/grep micro
...
./microshell /bin/ls ewqew "|" /bin/grep micro "|" /bin/cat -n ";" /bin/echo dernier ";" /bin/echo
./microshell /bin/ls "|" /bin/grep micro "|" /bin/cat -n ";" /bin/echo dernier ";" /bin/echo ftest ";"
...
./microshell /bin/ls "|" /bin/grep micro ";" /bin/ls "|" /bin/grep micro ";" /bin/ls "|" /bin/grep micro ";" /bin/ls "|" /bin/grep micro ";"
./microshell /bin/cat reserv_microsh.c "|" /bin/grep a "|" /bin/grep b ";" /bin/cat reserv_microsh.c ";"
./microshell /bin/cat reserv_microsh.c "|" /bin/grep a "|" /bin/grep w ";" /bin/cat reserv_microsh.c ";"
./microshell /bin/cat reserv_microsh.c "|" /bin/grep a "|" /bin/grep w ";" /bin/cat reserv_microsh.c
./microshell /bin/cat reserv_microsh.c ";" /bin/cat reserv_microsh.c "|" /bin/grep a "|" /bin/grep b "|" /bin/grep z ";" /bin/cat reserv_microsh.c
./microshell ";" /bin/cat reserv_microsh.c ";" /bin/cat reserv_microsh.c "|" /bin/grep a "|" /bin/grep b "|" /bin/grep z ";" /bin/cat reserv_microsh.c
